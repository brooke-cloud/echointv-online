        ...
        <section className="mt-10 grid grid-cols-1 gap-6 sm:grid-cols-2 xl:grid-cols-4">
          ...
          <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
            ...
            <p className="mt-5 text-sm text-gray-500">
              Unique companies in problem database
            </p>
          </div>
        ...
        <section className="mt-10">
          ...
          <div className="mt-5 flex flex-wrap gap-4">
            ...
            <Link
              ...
              className="rounded-xl border border-gray-300 bg-white px-5 py-3 font-medium text-gray-700 transition hover:border-blue-600 hover:text-blue-700"
            >
              Add Blog Post
            </Link>
